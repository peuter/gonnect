...
#  - semver modifications Tobias Bräutigam <braeutigam@gonicus.de>
...
``GITVERSIONDETECT_VERSION_PRE``
  Pre-release version matched from GITVERSIONDETECT_VERSION.
...
string(REGEX MATCH "^([0-9]+)\\.([0-9]+)\\.([0-9]+)(-[0-9A-Za-z]*)(-([0-9]+)-([a-z0-9]+))?" GITVERSIONDETECT_VERSION_MATCH ${GITVERSIONDETECT_VERSION})
...
set(GITVERSIONDETECT_VERSION_PRE ${CMAKE_MATCH_4})
# semver adjustments needs + as prefix for build number
string(REGEX REPLACE "^-" "+" GITVERSIONDETECT_VERSION_COMMIT_NUM "${CMAKE_MATCH_6}")
set(GITVERSIONDETECT_VERSION_COMMIT_SHA ${CMAKE_MATCH_7})
